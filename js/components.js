            ...
            <nav class="desktop-main-nav">
                ...
                <div class="nav-dropdown-container">
                    ...
                    <div class="nav-dropdown-menu">
                        ...
                        <a href="${pathPrefix}tools/excel/excel.html" class="dropdown-item green-hover"><img src="${pathPrefix}assets/logos/excel-logo.svg" style="width:16px; height:16px; margin-right:8px; object-fit:contain; border-radius:3px; vertical-align:middle;"> Excel</a>
                        ...
                        <a href="${pathPrefix}tools/tableau/tableau.html" class="dropdown-item green-hover"><img src="${pathPrefix}assets/logos/tableau-logo.svg" style="width:16px; height:16px; margin-right:8px; object-fit:contain; border-radius:3px; vertical-align:middle;"> Tableau</a>
                        <a href="${pathPrefix}tools/spss/spss.html" class="dropdown-item green-hover"><img src="${pathPrefix}assets/logos/spss-logo.svg" style="width:16px; height:16px; margin-right:8px; object-fit:contain; border-radius:3px; vertical-align:middle;"> SPSS</a>
                        <a href="${pathPrefix}tools/stata/stata.html" class="dropdown-item green-hover"><img src="${pathPrefix}assets/logos/stata-logo.svg" style="width:16px; height:16px; margin-right:8px; object-fit:contain; border-radius:3px; vertical-align:middle;"> Stata</a>
                        <a href="${pathPrefix}tools/eviews/eviews.html" class="dropdown-item green-hover"><img src="${pathPrefix}assets/logos/eviews-logo.svg" style="width:16px; height:16px; margin-right:8px; object-fit:contain; border-radius:3px; vertical-align:middle;"> EViews</a>
                        ...
                        <a href="${pathPrefix}tools/sas/sas.html" class="dropdown-item green-hover"><img src="${pathPrefix}assets/logos/sas-logo.svg" style="width:16px; height:16px; margin-right:8px; object-fit:contain; border-radius:3px; vertical-align:middle;"> SAS</a>
                        ...
                        <a href="${pathPrefix}tools/matlab/matlab.html" class="dropdown-item green-hover"><img src="${pathPrefix}assets/logos/matlab-logo.svg" style="width:16px; height:16px; margin-right:8px; object-fit:contain; border-radius:3px; vertical-align:middle;"> MATLAB</a>
    ...
    <div class="mobile-nav-menu" id="mobile-nav-menu">
        <div class="mobile-nav-panel">
            ...
            <div id="tools-accordion" style="display: none; flex-direction: column; gap: 8px; width: 100%; margin-top: -4px; margin-bottom: 8px; padding-left: 16px; border-left: 2px solid rgba(52, 211, 153, 0.3);">
                ...
                <button class="mobile-nav-item" onclick="window.location.href='${pathPrefix}tools/excel/excel.html'" style="font-size: 0.9rem; padding: 12px 16px;"><img src="${pathPrefix}assets/logos/excel-logo.svg" style="width:16px; height:16px; margin-right:8px; object-fit:contain; border-radius:3px; vertical-align:middle;"> Excel</button>
                ...
                <button class="mobile-nav-item" onclick="window.location.href='${pathPrefix}tools/tableau/tableau.html'" style="font-size: 0.9rem; padding: 12px 16px;"><img src="${pathPrefix}assets/logos/tableau-logo.svg" style="width:16px; height:16px; margin-right:8px; object-fit:contain; border-radius:3px; vertical-align:middle;"> Tableau</button>
                <button class="mobile-nav-item" onclick="window.location.href='${pathPrefix}tools/spss/spss.html'" style="font-size: 0.9rem; padding: 12px 16px;"><img src="${pathPrefix}assets/logos/spss-logo.svg" style="width:16px; height:16px; margin-right:8px; object-fit:contain; border-radius:3px; vertical-align:middle;"> SPSS</button>
                <button class="mobile-nav-item" onclick="window.location.href='${pathPrefix}tools/stata/stata.html'" style="font-size: 0.9rem; padding: 12px 16px;"><img src="${pathPrefix}assets/logos/stata-logo.svg" style="width:16px; height:16px; margin-right:8px; object-fit:contain; border-radius:3px; vertical-align:middle;"> Stata</button>
                <button class="mobile-nav-item" onclick="window.location.href='${pathPrefix}tools/eviews/eviews.html'" style="font-size: 0.9rem; padding: 12px 16px;"><img src="${pathPrefix}assets/logos/eviews-logo.svg" style="width:16px; height:16px; margin-right:8px; object-fit:contain; border-radius:3px; vertical-align:middle;"> EViews</button>
                ...
                <button class="mobile-nav-item" onclick="window.location.href='${pathPrefix}tools/sas/sas.html'" style="font-size: 0.9rem; padding: 12px 16px;"><img src="${pathPrefix}assets/logos/sas-logo.svg" style="width:16px; height:16px; margin-right:8px; object-fit:contain; border-radius:3px; vertical-align:middle;"> SAS</button>
